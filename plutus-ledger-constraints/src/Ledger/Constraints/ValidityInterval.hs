...
{-# INLINABLE to #-}
-- | @to a@ is an 'ValidityInterval' that includes all values that are
--  smaller than to @a@. In math. notation: [-∞,a)
to :: a -> ValidityInterval a
to s = ValidityInterval Nothing (Just s)
